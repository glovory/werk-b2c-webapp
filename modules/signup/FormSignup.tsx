      ...
      <main className="text-center d-flex flex-column align-items-center flex-grow-1">
        <div className="col-md-4 col-sm-6">
          ...
          <Image
            ...
            draggable={false}
            className="d-inline-block mt-7 mb-5"
          />

          <Button onClick={() => router.push("/linkedin-connect")} className="col-12 col-md-9 mt-6">
          ...
          <Button onClick={() => router.push("/set-up-profile")} className="col-12 col-md-9 fw-bold mt-9" variant="light">Skip this step</Button>
        </div>
      </main>
    </>
  )
